...
namespace KPI.Model.DAO
{
    public class FactoryAdminDAO
    {
        ...
        public IEnumerable<EF.Factory> GetAll()
        {
            return _dbContext.Factorys.ToList();
        }
        public EF.Factory GetbyID(int ID)
        {
            return _dbContext.Factorys.FirstOrDefault(x => x.ID == ID);
        }
        ...
        {
            List<EF.Factory> listData = _dbContext.Factorys.ToList();
